...
const BACKGROUND_VIDEO_SRC =
  "/background_music/White Fabric Wind Free Background Videos, Motion Graphics, No Copyright All Background Videos (online-video-cutter.com).mp4"
      ...
      <div className="relative z-10 flex flex-col items-center text-center p-6 w-full max-w-md mx-auto h-full">
        ...
        <div className="flex flex-col items-center justify-end w-full gap-5 sm:gap-6 pb-14 sm:pb-16 md:pb-20">
          ...
          <button
            type="button"
            onClick={onOpen}
            className={`rounded-sm border px-10 py-4 text-sm uppercase tracking-[0.18em] transition-all duration-500 delay-500 active:scale-[0.98] hover:-translate-y-0.5 ${
              contentVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
            }`}
            style={{
              ...
              boxShadow:
                "0 10px 24px color-mix(in srgb, var(--color-motif-deep) 18%, transparent)",
            }}
            onMouseEnter={(e) => {
